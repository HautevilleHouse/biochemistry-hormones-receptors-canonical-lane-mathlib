import BiochemistryHormonesReceptorsCanonicalLaneLean.BiochemistryObjects

namespace HautevilleHouse
namespace BiochemistryHormonesReceptorsCanonicalLaneLean

structure BiochemistryProofObligation where
  sourceKey : String
...
def mathlibProofObligation : BiochemistryProofObligation := {
  sourceKey := "biochemistry-hormones-receptors-canonical-lane",
  theoremObject := "Hormone-receptor binding curve closure under Michaelis-Menten kinetics",
...
theorem theorem_specific_endgame_pilot_checked :
  ...
  intro A
  exact constrained_biochemistry_endgame A
